/**
 * @file src/handlers/appointment_cl.ts
 * @author Gianpiero Benvenuto
 * @description Procesa lotes de mensajes SQS que contienen datos de citas, inserta cada cita en la base de datos RDS, publica un evento de cita completada en EventBridge y registra toda la actividad en CloudWatch (Chile).
 */
